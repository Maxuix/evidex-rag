...
CORPUS_ROOT = ROOT / "evaluation/enterprise-profile-qualification-v1"
...
def _spec(arm: str) -> tuple[str, ProvisioningSpec]:
    ...
    spec = ProvisioningSpec(
        dataset_id=f"enterprise-profile-quality-pilot-{arm}-v1",
        corpus_root=CORPUS_ROOT / "documents",
        expected_document_count=138,
        knowledge_base_name=f"enterprise-profile-quality-pilot-{arm}-graphiti-v4",
...
def main() -> int:
    ...
    dataset_key, spec = _spec(arguments.arm)
