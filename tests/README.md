...
Unit of Work behavior against the pinned PostgreSQL/pgvector image. Contract
tests drive the ASGI application directly and freeze Problem Details, cursor,
idempotency, lifespan, and OpenAPI behavior. End-to-end tests are populated by
later eligible work items.
